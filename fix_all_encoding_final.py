...
# All mojibake patterns found in the file
replacements = [
    # Buttons
    ...
    (b'Trung b\xc4\x82\xcc\x80nh', b'Trung b\xc3\xacnh'),  # Trung bình
    (b'\xc3\x84i\xc3\xa1\xc2\xbb\xc2\x83m trung b\xc4\x82\xcc\x80nh', b'\xc4\x90i\xe1\xbb\x83m trung b\xc3\xacnh'),  # Điểm trung bình
    (b'\xc3\x84i\xc3\xa1\xc2\xbb\xc2\x83m r\xc3\x83\xc2\xa8n luy\xc3\xa1\xc2\xbb\xc2\x87n', b'\xc4\x90i\xe1\xbb\x83m r\xc3\xa8n luy\xe1\xbb\x87n'),  # Điểm rèn luyện
    
    # Details
    (b'Chi ti\xc3\xa1\xc2\xba\xc2\xbft th\xc3\xa1\xc2\xbb\xe2\x80\x99ng k\xc3\x83\xc2\xaa', b'Chi ti\xe1\xba\xbft th\xe1\xbb\x91ng k\xc3\xaa'),  # Chi tiết thống kê
...
print(f'✅ Fixed {count} encoding issues in ModernReports.js')
