...
# Direct byte replacements for mojibake
replacements = [
    (b'Tu\xc3\xa1\xc2\xba\xc2\xa7n n\xc4\x82\xc2\xa0y', b'Tu\xe1\xba\xa7n n\xc3\xa0y'),  # Tuần này
    (b'Th\xc3\xa1ng n\xc4\x82\xc2\xa0y', b'Th\xc3\xa1ng n\xc3\xa0y'),  # Tháng này
    (b'N\xc4\x83m n\xc4\x82\xc2\xa0y', b'N\xc4\x83m n\xc3\xa0y'),  # Năm này
    (b'L\xc3\xa0m m\xc3\xa1\xc2\xbb\xc2\x9bi', b'L\xc3\xa0m m\xe1\xbb\x9bi'),  # Làm mới
    (b'Xu\xc3\xa1\xc2\xba\xc2\xa5t Excel', b'Xu\xe1\xba\xa5t Excel'),  # Xuất Excel
    (b'Xu\xc3\xa1\xc2\xba\xc2\xa5t PDF', b'Xu\xe1\xba\xa5t PDF'),  # Xuất PDF
    ...
    (b'Trong kho\xc3\xa1\xc2\xba\xc2\xa3ng th\xc3\xa1\xc2\xbb\xc2\x9di gian', b'Trong kho\xe1\xba\xa3ng th\xe1\xbb\x9di gian'),  # Trong khoảng thời gian
    ...
    (b'Trung b\xc3\xacnh', b'Trung b\xc3\xacnh'),  # Trung bình (already correct)
    ...
    (b'Xu\xc3\xa1\xc2\xba\xc2\xa5t b\xc3\xa1o c\xc3\xa1o', b'Xu\xe1\xba\xa5t b\xc3\xa1o c\xc3\xa1o'),  # Xuất báo cáo
...
for mojibake, correct in replacements:
    if mojibake in data:
        ...
        count += 1
        print(f'✓ Fixed: {mojibake[:20]}... -> {correct[:20]}...')

if count > 0:
    file_path.write_bytes(data)
    print(f'\n✅ Fixed {count} encoding issues in ModernReports.js')
else:
    print('✗ No encoding issues found or patterns did not match')
