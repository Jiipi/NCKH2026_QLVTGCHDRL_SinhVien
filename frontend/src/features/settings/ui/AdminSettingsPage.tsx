...
const SimpleAdminSettings: React.FC = () => {
  ...
  const handleSettingChange = (key: keyof SystemSettings, value: string | number | boolean): void => {
    setSettings(prev => ({
      ...prev,
      [key]: value
    }));
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button 
            ...
            onMouseEnter={(e) => (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#4b5563'}
            onMouseLeave={(e) => (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#6b7280'}
          >
            <RefreshCw size={20} />
            Tải lại
          </button>
          <button 
            ...
            onMouseEnter={(e) => !saving && ((e.currentTarget as HTMLButtonElement).style.backgroundColor = '#059669')}
            onMouseLeave={(e) => !saving && ((e.currentTarget as HTMLButtonElement).style.backgroundColor = '#10b981')}
          >
