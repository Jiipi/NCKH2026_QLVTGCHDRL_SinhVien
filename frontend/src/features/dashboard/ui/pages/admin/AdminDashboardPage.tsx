...
import { useAdminDashboard } from '../../../model/hooks/useAdminDashboard';
import { 
...
} from '../../shared/MobileOptimizedDashboard';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mt-6">
                <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 p-4 sm:p-6">
                    ...
                    <MobileOptimizedEmptyState
                        ...
                        description="Nhật ký hoạt động chi tiết sẽ sớm được hiển thị ở đây."
                    />
                </div>
                <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 p-4 sm:p-6">
                    ...
                    <MobileOptimizedEmptyState
                        ...
                        description="Tạo thông báo mới để gửi đến toàn bộ người dùng."
                    />
                </div>
            </div>
        </div>
