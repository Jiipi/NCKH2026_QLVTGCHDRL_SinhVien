...
interface MobileOptimizedStatCardProps {
  title: string;
  value: number | string;
...
export function MobileOptimizedStatCard({ title, value, icon, color = 'blue', change, trend, subtitle, onClick }: MobileOptimizedStatCardProps) {
...
interface MobileOptimizedActionCardProps {
  title: string;
  description: string;
  icon: React.ReactNode;
 ...
 */
export function MobileOptimizedActionCard({ title, description, icon, color = 'blue', onClick, badge }: MobileOptimizedActionCardProps) {
  const colorClasses: Record<string, string> = {
 ...
 * Desktop: 4 columns
 */
export function MobileOptimizedGrid({ children, type = 'stats' }: MobileOptimizedGridProps) {
 ...
 */
export function MobileOptimizedHeader({ title, subtitle, badge, action, children }: MobileOptimizedHeaderProps) {
  return (
 ...
 */
export function MobileOptimizedSection({ title, action, children, className = '' }: MobileOptimizedSectionProps) {
  return (
...
interface MobileOptimizedEmptyStateProps {
  icon?: React.ReactNode;
  title: string;
  description?: string;
  action?: React.ReactNode;
 ...
 */
export function MobileOptimizedEmptyState({ icon, title, description, action }: MobileOptimizedEmptyStateProps) {
  return (
