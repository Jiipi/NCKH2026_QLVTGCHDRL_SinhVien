...
export function useStudentDashboard(semester) {
    ...
    console.log('[useStudentDashboard] profileResult:', profileResponse);
        ...
        if (dashboardResult.success && 'data' in dashboardResult && profileResponse.success && 'data' in profileResponse) {
            ...
            const errMsg = ('error' in dashboardResult ? dashboardResult.error : null) || ('error' in profileResponse ? profileResponse.error : null) || 'Không thể tải dữ liệu dashboard.';
