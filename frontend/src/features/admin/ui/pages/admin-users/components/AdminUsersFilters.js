        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-3 bg-gray-100 border-2 border-gray-200 rounded-2xl px-4 py-2 text-sm font-semibold text-gray-700">
            ...
            >
              ...
              {roles.map((role) => {
                const value = role.ten_vt || role.ten_vai_tro || role.name || role.code || '';
                return (
                  <option key={role.id || value} value={value}>
          ...
          <div className="text-sm font-semibold text-gray-500">{countLabel}</div>
