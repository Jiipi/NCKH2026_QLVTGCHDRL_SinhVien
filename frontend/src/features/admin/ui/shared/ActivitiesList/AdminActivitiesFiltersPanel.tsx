...
import { Calendar, Filter, Clock, RefreshCw, Tag, LucideIcon } from 'lucide-react';
...
interface AdminActivitiesFiltersPanelProps {
  visible: boolean;
  filters: Filters;
...
export default function AdminActivitiesFiltersPanel({
  ...
  onClearAll,
  activeFilterCount = 0
}: AdminActivitiesFiltersPanelProps): React.ReactElement | null {
  if (!visible) {
    return null;
  }
