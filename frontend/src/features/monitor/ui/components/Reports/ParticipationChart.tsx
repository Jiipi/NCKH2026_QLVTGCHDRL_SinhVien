 ...
 */
export default function ParticipationChart({ data: pointsDistribution = [] }: ParticipationChartProps) {
            ...
            <PieChart>
              ...
              <Tooltip 
                ...
                formatter={(value, name, props) => {
                  ...
                  const pct = item?.percentage ?? (total ? ((numValue / total) * 100).toFixed(1) : 0);
