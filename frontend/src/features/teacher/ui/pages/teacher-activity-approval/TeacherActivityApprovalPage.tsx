...
import ActivityApprovalHero from '../../shared/activity-approval/ActivityApprovalHero';
import ActivityApprovalControls from '../../shared/activity-approval/ActivityApprovalControls';
import ActivityApprovalStatusTabs from '../../shared/activity-approval/ActivityApprovalStatusTabs';
import ActivityApprovalGridCard from '../../shared/activity-approval/ActivityApprovalGridCard';
import ActivityApprovalListItem from '../../shared/activity-approval/ActivityApprovalListItem';
import ActivityApprovalEmptyState from '../../shared/activity-approval/ActivityApprovalEmptyState';
      ...
      {filteredActivities.length > 0 && (
        <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-6">
          ...
          <Pagination
            ...
            onLimitChange={(limit: number | string) => setPagination((prev) => ({ ...prev, page: 1, limit: Number(limit) }))}
            itemLabel="hoạt động"
            showLimitSelector
          />
        </div>
