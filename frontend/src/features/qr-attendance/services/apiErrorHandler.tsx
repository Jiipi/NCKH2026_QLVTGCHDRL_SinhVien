...
export const createSuccessResponse = (data: unknown = null, message: string | null = null) => {
  const response: { success: boolean; data: unknown; message?: string } = { success: true, data };
