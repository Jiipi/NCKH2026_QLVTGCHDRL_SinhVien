...
export const RegistrationStatusTabs: FC<RegistrationStatusTabsProps> = ({ 
  activeTab, 
  onTabChange, 
  counts 
}: RegistrationStatusTabsProps) => {
  const [viewMode, setViewMode] = useState<'pills' | 'dropdown' | 'compact'>('pills');
...
export default RegistrationStatusTabs;
