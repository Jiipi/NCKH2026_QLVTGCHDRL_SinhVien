...
import { getStatusColor } from '../../model/utils/activityUiHelpers';
...
interface TeacherActivityGridProps {
  activities: Activity[];
...
export const TeacherActivityGrid: FC<TeacherActivityGridProps> = ({ 
  activities, 
  onViewDetails, 
  onApprove, 
  onReject, 
