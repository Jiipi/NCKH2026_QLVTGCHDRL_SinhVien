...
interface ActivityRegistration {
  ...
  ngay_dang_ky?: string | Date;
  ngay_duyet?: string | Date;
...
export const MyActivityCard: FC<MyActivityCardProps> = ({ 
  ...
  const activityData = (activityRegistration.hoat_dong || activityRegistration) as ActivityData;
