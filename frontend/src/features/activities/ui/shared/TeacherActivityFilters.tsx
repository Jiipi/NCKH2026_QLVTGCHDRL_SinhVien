...
interface TeacherActivityFiltersProps {
  searchTerm: string;
  ...
  onPaginationChange: (key: 'limit' | 'page', value: number) => void;
}

export const TeacherActivityFilters: FC<TeacherActivityFiltersProps> = ({ 
