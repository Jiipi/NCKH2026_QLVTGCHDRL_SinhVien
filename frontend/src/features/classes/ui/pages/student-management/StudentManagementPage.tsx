...
export default function ModernStudentManagement() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const params: { search?: string; classFilter?: string | null; classId?: string | null } = {};
            ...
            <div className="divide-y divide-gray-200">
              {classes.map((cls) => (
                <button
                  ...
                  className={`w-full p-4 text-left transition-colors ${selectedClass === cls.id
              ...
              <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
                ...
                <div className="flex border-b border-gray-200 px-6">
                  <button
                    ...
                    className={`py-3 px-4 font-medium transition-colors ${activeTab === 'basic'
                  ...
                  <button
                    ...
                    className={`py-3 px-4 font-medium transition-colors ${activeTab === 'academic'
                        ? 'text-indigo-600 border-b-2 border-indigo-600'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`py-3 px-4 font-medium transition-colors ${activeTab === 'personal'
                        ? 'text-indigo-600 border-b-2 border-indigo-600'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                  >
