...
function buildActivityMeta(activity: Activity = {}, role: string, isWritable: boolean) {
...
function ActionButton({ onClick, icon: Icon, label, gradient, fullWidth }: ActionButtonProps) {
  return (
    <button
      onClick={onClick}
