...
import type { ActivityTypeItem } from '../../model/hooks/useActivityTypes';

interface ActivityTypeListProps {
  items: ActivityTypeItem[];
  onEdit: (item: ActivityTypeItem) => void;
  onRemove: (id: string) => void;
}

const ActivityTypeList: FC<ActivityTypeListProps> = ({ items, onEdit, onRemove }) => {
  return (
