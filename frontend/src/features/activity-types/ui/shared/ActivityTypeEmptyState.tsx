...
interface ActivityTypeEmptyStateProps {
  search: string;
  onCreateClick: () => void;
}

const ActivityTypeEmptyState: FC<ActivityTypeEmptyStateProps> = ({ search, onCreateClick }) => {
  return (
...
export default ActivityTypeEmptyState;
