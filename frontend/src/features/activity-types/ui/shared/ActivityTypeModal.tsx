...
const ActivityTypeModal: React.FC<ActivityTypeModalProps> = ({
  ...
  const handleTextChange = (field: 'ten_loai_hd' | 'mo_ta' | 'mau_sac') => (
    e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
  ): void => {
    onFormChange({ ...form, [field]: e.target.value });
  };

  const handleNumberChange = (field: 'diem_mac_dinh' | 'diem_toi_da') => (
    e: ChangeEvent<HTMLInputElement>
  ): void => {
    onFormChange({ ...form, [field]: parseFloat(e.target.value) || 0 });
  };
          ...
          <form onSubmit={onSubmit} className="p-6 space-y-6 bg-gray-50/60">
            <div>
              ...
              <input
                ...
                onChange={handleTextChange('ten_loai_hd')}
            ...
            <div>
              ...
              <textarea
                value={form.mo_ta}
                onChange={handleTextChange('mo_ta')}
                rows={4}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleNumberChange('diem_mac_dinh')}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={handleNumberChange('diem_toi_da')}
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  type="color"
                  value={form.mau_sac}
                  onChange={handleTextChange('mau_sac')}
