...
const AdminDashboard = React.lazy(() => import('./features/admin').then(module => ({ default: module.AdminDashboardPage })));
const AdminUsers = React.lazy(() => import('./features/admin').then(module => ({ default: module.AdminUsersPage })));
const AdminActivities = React.lazy(() => import('./features/admin').then(module => ({ default: module.AdminActivitiesPage })));
...
function RoleGuard({ allow, element }: RoleGuardProps) {
...
function PermissionRouteGuard({ permission, anyOf, allOf, element, fallbackPath = '/student' }: PermissionRouteGuardProps) {
