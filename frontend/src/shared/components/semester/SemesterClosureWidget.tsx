...
interface SemesterClosureWidgetProps {
  compact?: boolean;
  onChanged?: () => void;
  classId?: string | null;
...
export default function SemesterClosureWidget({ compact = false, onChanged, classId: forcedClassId = null, enableSoftLock = false, enableHardLock = false, className = '', allowProposeWithoutClass = false }: SemesterClosureWidgetProps) {
