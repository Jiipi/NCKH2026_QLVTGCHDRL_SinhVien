 ...
 */
const isRealImage = (imageUrl: string | null | undefined): boolean => {
 ...
 */
const getRealImages = (images: string[]): string[] => {
...
export default function ActivityImageSlideshow({ 
  ...
  showDots = false,
  dotsPosition = 'bottom'
}: ActivityImageSlideshowProps): React.JSX.Element {
  ...
  const handleImageError = (e: React.SyntheticEvent<HTMLImageElement>) => {
    if (onError) {
      ...
      (e.target as HTMLImageElement).src = getActivityImage(null, activityType);
    }
  };
