...
export const DATA_CHANGE_EVENTS: Record<string, string> = {
 ...
 */
export function emitDataChange(type: string, detail: DataChangeDetail = {}): void {
 ...
 */
export const emitActivitiesChange = (detail?: DataChangeDetail): void => emitDataChange('ACTIVITIES', detail);
export const emitRegistrationsChange = (detail?: DataChangeDetail): void => emitDataChange('REGISTRATIONS', detail);
export const emitApprovalsChange = (detail?: DataChangeDetail): void => emitDataChange('APPROVALS', detail);
export const emitScoresChange = (detail?: DataChangeDetail): void => emitDataChange('SCORES', detail);
export const emitActivityTypesChange = (detail?: DataChangeDetail): void => emitDataChange('ACTIVITY_TYPES', detail);
export const emitAttendanceChange = (detail?: DataChangeDetail): void => emitDataChange('ATTENDANCE', detail);
 ...
 * @param {object} options - Options like debounce time
 */
export function useAnyDataChangeListener(
  callback: () => void,
  options: DataChangeListenerOptions = {}
): void {
