 ...
 */
export const getDefaultActivityImage = (activityType?: string): string => {
...
function prefixUploadsIfNeeded(url: string | null | undefined): string | null | undefined {
  try {
...
export const getActivityImage = (images: string | string[] | { url?: string; path?: string; src?: string } | null | undefined, activityType?: string): string => {
  ...
  try {
    ...
    if (Array.isArray(images)) {
      ...
      if (typeof firstEntry === 'string') first = firstEntry;
        ...
        const entry = firstEntry as { url?: string; path?: string; src?: string };
        first = entry.url || entry.path || entry.src || null;
      }
      ...
      first = imgObj.url || imgObj.path || imgObj.src || null;
    }
 ...
 */
export const getActivityImages = (images: string | Array<string | { url?: string; path?: string; src?: string } | null> | { url?: string; path?: string; src?: string } | null | undefined, activityType?: string): string[] => {
  try {
      ...
      return images
        .map(item => {
          ...
          if (typeof item === 'object') {
            const obj = item as { url?: string; path?: string; src?: string };
            return prefixUploadsIfNeeded(obj.url || obj.path || obj.src || null);
          }
          return null;
        })
        .filter(Boolean);
...
interface ActivityImageSource {
  ...
  anh_hoat_dong?: string | string[];
  image?: string | string[];
  thumbnail?: string | string[];
  anh_bia?: string | string[];
  banner?: string | string[];
  cover?: string | string[];
  cover_image?: string | string[];
  coverImage?: string | string[];
  thumb_url?: string | string[];
  loai_hd?: { ten_loai_hd?: string };
  loai?: string;
}
 ...
 * @returns {string} url
 */
export const getBestActivityImage = (activity: ActivityImageSource | null | undefined): string => {
