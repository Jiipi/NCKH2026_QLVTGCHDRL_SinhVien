...
const filePath = 'd:\\DACN_Web_quanly_hoatdongrenluyen-master\\frontend\\src\\pages\\teacher\\ModernReports.js';
let content = fs.readFileSync(filePath, 'utf8');

// Fix all mojibake Vietnamese characters
const replacements = {
...
for (const [mojibake, correct] of Object.entries(replacements)) {
  content = content.replace(new RegExp(mojibake.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), 'g'), correct);
}

fs.writeFileSync(filePath, content, 'utf8');
console.log('✓ Fixed all Vietnamese encoding issues in ModernReports.js');
