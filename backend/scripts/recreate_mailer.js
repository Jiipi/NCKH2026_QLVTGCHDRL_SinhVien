...
const content = `// src/utils/mailer.js
let nodemailer = null;
...
fs.writeFileSync('d:/DACN_Web_quanly_hoatdongrenluyen-master/backend/src/utils/mailer.js', content, 'utf8');
console.log('✅ File mailer.js đã được tạo thành công!');
