...
// notificationTypesService removed - use notification-types module use cases instead
const notificationTypesRepository = require('../../modules/notification-types/data/repositories/notification-types.repository');
const ListNotificationTypesUseCase = require('../../modules/notification-types/business/services/ListNotificationTypesUseCase');
const GetNotificationTypeByIdUseCase = require('../../modules/notification-types/business/services/GetNotificationTypeByIdUseCase');
const CreateNotificationTypeUseCase = require('../../modules/notification-types/business/services/CreateNotificationTypeUseCase');
const UpdateNotificationTypeUseCase = require('../../modules/notification-types/business/services/UpdateNotificationTypeUseCase');
const DeleteNotificationTypeUseCase = require('../../modules/notification-types/business/services/DeleteNotificationTypeUseCase');
...
router.post('/notification-types', async (req, res) => {
  try {
    const item = await createNotificationTypeUseCase.execute(req.body, req.user?.id);
    const { ApiResponse, sendResponse } = require('../../core/http/response/apiResponse');
...
router.put('/notification-types/:id', async (req, res) => {
  try {
    const updated = await updateNotificationTypeUseCase.execute(req.params.id, req.body, req.user?.id);
    const { ApiResponse, sendResponse } = require('../../core/http/response/apiResponse');
...
router.delete('/notification-types/:id', async (req, res) => {
  try {
    await deleteNotificationTypeUseCase.execute(req.params.id, req.user?.id);
    const { ApiResponse, sendResponse } = require('../../core/http/response/apiResponse');
