...
const profileRepository = require('../../modules/profile/data/repositories/profile.repository');
const CheckClassHasMonitorUseCase = require('../../modules/profile/business/services/CheckClassHasMonitorUseCase');
