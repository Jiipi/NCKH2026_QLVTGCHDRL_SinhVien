...
// ⚠️ DEPRECATED V1 DASHBOARD ROUTE
// This file is deprecated. Use V2 routes instead:
//   - /api/v2/dashboard/student (replaces /dashboard/student)
//   - /api/v2/dashboard/admin (admin dashboard stats)
//   - /api/v2/dashboard/activity-stats (activity statistics)
...
// Controller deleted - migrated to modules/dashboard/
