...
const { createAuthController } = require('../auth.factory');
...
} = require('../../business/validators/auth.validators');
 ...
 * @access  Public
 */
router.get('/classes', (req, res) => authController.getAllClasses(req, res));
