...
const INotificationRepository = require('../../business/interfaces/INotificationRepository');
...
class NotificationPrismaRepository extends INotificationRepository {
  ...
  async getSentStats(userId) {
    // Get unique notification batches by grouping by title and date
    ...
    // Group notifications (same logic as GetSentNotificationsUseCase)
