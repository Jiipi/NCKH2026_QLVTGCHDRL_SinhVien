...
import GetUsersDto from '../../business/dto/GetUsersDto';
...
import type CreateUserUseCase from '../../business/services/CreateUserUseCase';
import type UpdateUserUseCase from '../../business/services/UpdateUserUseCase';
import type DeleteUserUseCase from '../../business/services/DeleteUserUseCase';
import type ExportUsersUseCase from '../../business/services/ExportUsersUseCase';
...
class AdminUsersController {
  ...
  async createUser(req: AuthRequest, res: Response): Promise<Response> {
    try {
   ...
   * Lock user account
   */
  async lockUser(req: AuthRequest, res: Response): Promise<Response> {
    try {
   ...
   * Unlock user account
   */
  async unlockUser(req: AuthRequest, res: Response): Promise<Response> {
    try {
      const userId = req.params.id;
      const adminId = req.user?.sub || req.user?.id;
   ...
   */
  async getUserPoints(req: AuthRequest, res: Response): Promise<Response> {
    try {
      const userId = req.params.id;
